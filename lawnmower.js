function LawnMowerGameInit() {
  ...
  hud.style.gap = '20px';
  hud.style.fontFamily = 'ParkinSans, sans-serif';
  ...
  scoreDiv.style.padding = '8px 16px';
  scoreDiv.style.borderRadius = '8px';

  const leftDiv = document.createElement('div');
  leftDiv.innerHTML = 'Grass left: <span id="left">0</span>';
  leftDiv.style.backgroundColor = 'rgba(0,0,0,0.5)';
  leftDiv.style.padding = '8px 16px';
  leftDiv.style.borderRadius = '8px';

  const fuelDiv = document.createElement('div');
  fuelDiv.innerHTML = 'Fuel: <span id="fuel">100</span>%';
  fuelDiv.style.backgroundColor = 'rgba(0,0,0,0.5)';
  fuelDiv.style.padding = '8px 16px';
  fuelDiv.style.borderRadius = '8px';
  ...
  function draw(){
    ...
    if(paused){
      ...
      ctx.fillStyle='white';
      ctx.font='36px ParkinSans, sans-serif';
